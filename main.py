...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
     description='Processes a CSV file and generates .csv and .mp3 files based on the specified options.',
     epilog="Quick Start: python ankiflash.py test_decks/russian.csv -l russian")
